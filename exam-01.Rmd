...
***First I joined flights with airportNames and planes to have airtime, airport names, and number of seats in the same data set. Then I selected airtime, airport names, and number of seats and arranged them in descending order by air time, so the longest would be first, then I sliced it so only the flight with the longest air time would show.***
